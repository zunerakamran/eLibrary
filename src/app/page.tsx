        ...
        <>
            <div className="hero-container my-6">
                <div className="hero-section-container">
                    ...
                    <Link href="#homeContainer" className="library-button">Explore Now</Link>
                </div>
            </div>
            <div className="container mx-auto px-4" id="homeContainer">
                ...
                <div className="flex flex-wrap -mx-4 pb-3">
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 mt-3">
                        <Link href="/categories/fiction" className="gallery-clickable-content">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 mt-3">
                        <Link href="/categories/children" className="gallery-clickable-content">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 px-4 mt-3">
                        <Link href="/categories/history" className="gallery-clickable-content">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 px-4 mt-3">
                        <Link href="/categories/all" className="gallery-clickable-content">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 mt-3">
                        <Link href="/categories/biography" className="gallery-clickable-content">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 mt-3">
                        <Link href="/categories/arts" className="gallery-clickable-content">
